...
export default function ProtocolPage() {
    ...
    return (
        <div className="container">
            ...
            <p>Outline. Прост и легок в подключении. Однако расходует аккумулятор и легче заблокировать со стороны
                провайдера.</p>
            <p>VLESS. Есть возможность добавлять сайты, домены в исключения VPN. Есть роутинг. Сложнее заблокировать
                операторами связи.
